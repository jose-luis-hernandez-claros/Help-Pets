    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dg1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imagencambiante.setImageResource(R.drawable.salmon);
        ...
        dg2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imagencambiante.setImageResource(R.drawable.aceitesdepescado);
        ...
        dg4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imagencambiante.setImageResource(R.drawable.queso);
        ...
        dg5.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imagencambiante.setImageResource(R.drawable.pollo);
        ...
        dg6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imagencambiante.setImageResource(R.drawable.pavo);
        ...
        dg7.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                imagencambiante.setImageResource(R.drawable.vegetalesvariados);
